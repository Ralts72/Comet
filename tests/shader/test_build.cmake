...
function(reject_arguments EXPECTED)
    execute_process(COMMAND "${COMPILE_TOOL}" ${ARGN}
        RESULT_VARIABLE RESULT OUTPUT_VARIABLE OUTPUT ERROR_VARIABLE ERROR)
    if (RESULT EQUAL 0 OR NOT "${ERROR}" MATCHES "${EXPECTED}")
        message(FATAL_ERROR "Invalid arguments did not report ${EXPECTED}: ${OUTPUT}\n${ERROR}")
    endif ()
endfunction()
reject_arguments("Required:")
reject_arguments("Missing option value" --source)
reject_arguments("Unknown option" --unknown value)
reject_arguments("Duplicate define" --define VALUE=1 --define VALUE=2)
reject_arguments("Unsupported target" --target unsupported)
reject_arguments("Unsupported stage" --source "${ROOT}/source.vert" --stage unknown --output "${SPV}")
file(WRITE "${ROOT}/valid.vert" "#version 450\nvoid main(){gl_Position=vec4(1);}\n")
set(INVALID_OUTPUT "${ROOT}/invalid\noutput.spv")
reject_arguments("Newline in dependency path" --source "${ROOT}/valid.vert"
