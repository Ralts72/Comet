...
namespace {
    ...
    static_assert(
        !std::is_constructible_v<Sampler, std::nullptr_t, SamplerDesc>);
    static_assert(!std::is_invocable_v<CpuBufferFactory, std::nullptr_t,
        Flags<BufferUsage>, size_t, const void*, std::string_view>);
    static_assert(!std::is_invocable_v<ImageFactory, std::nullptr_t,
    ...
    static_assert(!std::is_invocable_v<ImageWrapper, std::nullptr_t,
        vk::Image, const ImageInfo&>);

    static_assert(std::is_invocable_v<CpuBufferFactory, Device&,
        Flags<BufferUsage>, size_t, const void*, std::string_view>);
    static_assert(std::is_invocable_v<ImageFactory, Device&,
        const ImageInfo&, SampleCount, std::string_view>);
