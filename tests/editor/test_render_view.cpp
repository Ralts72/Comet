...
namespace CometEditor::Tests {
    TEST(RenderViewTest, EditModeUsesCameraOverride) {
        ...
        const Comet::RenderView view = make_render_view(state, true, Comet::Math::Vec2u(1280, 720));
    ...
    TEST(RenderViewTest, PlayModeUsesScenePrimaryCamera) {
        ...
        EXPECT_EQ(view.camera_selection, Comet::RenderView::CameraSelection::ScenePrimary);
    ...
    TEST(RenderViewTest, OrthographicEditorCameraUsesFixedAxis) {
        ...
        ASSERT_TRUE(view.camera_override);
        EXPECT_EQ(view.camera_override->projection, Comet::RenderCamera::Projection::Orthographic);
        ...
        EXPECT_TRUE(Comet::Tests::TestUtils::Mat4Equal(view.camera_override->view_matrix,
            Comet::Math::look_at(state.camera.target + Comet::Math::Vec3(0.0f, 0.0f, distance),
    ...
    TEST(RenderViewTest, HiddenViewportPreservesCameraSelection) {
        ...
        const Comet::RenderView view = make_render_view(state, false, Comet::Math::Vec2u(0));
