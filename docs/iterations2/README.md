...
| 030 | typed enum／LightComponent／三类 forward 灯光及架构回顾 | Debug/Release 各 5 个 CTest；516 单元含专门同步对照、10 WSI、2 契约；17 项 ×20 |

阶段 4 本轮核心验收通过，扩展项保留在路线图；阶段 5／6 尚未完成。
阶段 3 的主线负载控制已补齐。下一项：阶段 5 方向光 shadow pass 与场景采样链路。
