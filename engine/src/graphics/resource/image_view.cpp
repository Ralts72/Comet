...
namespace Comet {
    std::shared_ptr<ImageView> ImageView::create(Device& device,
        std::shared_ptr<Image> image, const Flags<ImageAspect> aspect) {
    ...
    ImageView::ImageView(Device& device, std::shared_ptr<Image> image,
