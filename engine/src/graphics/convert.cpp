...
#define TRY_SET_BIT(src, dst)                                                                      \
    ...
    vk::ShaderStageFlags shader_stage_to_vk(const Flags<ShaderStage> flags) {
        ...
        TRY_SET_BIT(
            ShaderStage::TessellationEvaluation, vk::ShaderStageFlagBits::eTessellationEvaluation)
    ...
    vk::ImageUsageFlags image_usage_to_vk(const Flags<ImageUsage> flags) {
        ...
        TRY_SET_BIT(
            ImageUsage::DepthStencilAttachment, vk::ImageUsageFlagBits::eDepthStencilAttachment)
        return bits;
    }
    ...
    vk::PipelineStageFlags2 pipeline_stage_to_vk2(const Flags<PipelineStage> flags) {
        ...
        TRY_SET_BIT(
            PipelineStage::EarlyFragmentTests, vk::PipelineStageFlagBits2::eEarlyFragmentTests)
        TRY_SET_BIT(
            PipelineStage::LateFragmentTests, vk::PipelineStageFlagBits2::eLateFragmentTests)
    ...
    vk::AccessFlags2 access_to_vk2(const Flags<Access> flags) {
        ...
        TRY_SET_BIT(
            Access::DepthStencilAttachmentRead, vk::AccessFlagBits2::eDepthStencilAttachmentRead)
        TRY_SET_BIT(
            Access::DepthStencilAttachmentWrite, vk::AccessFlagBits2::eDepthStencilAttachmentWrite)
