...
namespace Comet {
    ...
    public:
        ...
        void begin(
            vk::CommandBufferUsageFlags flags = vk::CommandBufferUsageFlags{}) const;
    ...
    private:
        ...
        void copy_buffer_to_image(vk::Buffer src_buffer, vk::Image dst_image,
            ...
            uint32_t mip_level = 0, vk::DeviceSize buffer_offset = 0) const;
    ...
    public:
        ...
        [[nodiscard]] std::vector<CommandBuffer> allocate_command_buffers(
